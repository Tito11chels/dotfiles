# Generated by Powerlevel10k configuration wizard on 2022-01-29 at 14:50 JST.
...
() {
  ...
  # con overlap when using non-monospace fonts. When set to `none`, spaces are not added.
